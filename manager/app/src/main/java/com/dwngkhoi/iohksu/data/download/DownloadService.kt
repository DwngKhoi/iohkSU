package com.dwngkhoi.iohksu.data.download
...
import com.dwngkhoi.iohksu.data.update.ZipRangeArchive
import com.dwngkhoi.iohksu.ui.MainActivity
...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "com.dwngkhoi.iohksu.action.DOWNLOAD"
        const val ACTION_DOWNLOAD_MANAGER_APK = "com.dwngkhoi.iohksu.action.DOWNLOAD_MANAGER_APK"
        const val ACTION_CANCEL = "com.dwngkhoi.iohksu.action.CANCEL_DOWNLOAD"
        const val ACTION_DISMISS_DOWNLOAD = "com.dwngkhoi.iohksu.action.DISMISS_DOWNLOAD"
        const val ACTION_INSTALL_MODULE = "com.dwngkhoi.iohksu.action.INSTALL_MODULE"
    ...
    private fun reportProgress(id: Int, fileName: String, progress: Int) {
        downloadRepository.updateProgress(id, progress)
