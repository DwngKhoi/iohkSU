...
#define NativeBridge(fn, rtn, ...) JNIEXPORT rtn JNICALL  Java_com_iohksu_yakayn_Natives_##fn(JNIEnv* env, jclass clazz, __VA_ARGS__)
#define NativeBridgeNP(fn, rtn) JNIEXPORT rtn JNICALL Java_com_iohksu_yakayn_Natives_##fn(JNIEnv* env, jclass clazz)
