...
For languages other than English and Chinese Simplified, please don't create pull requests for translations; instead, use [Weblate](https://hosted.weblate.org/engage/iohkSU).

## Reporting bugs

Before reporting a bug, please first read the [document](https://iohkSU.github.io)
...
When you [Open an issue](https://github.com/DwngKhoi/iohkSU/issues), you **must**:
...
[Open an issue](https://github.com/DwngKhoi/iohkSU/issues) describing the feature you want and your reason for it.
...
```
>- then Joe Smith would upload the patch for iohkSU as
```
